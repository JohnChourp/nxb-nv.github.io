function toolRank(){
	...
	switch(document.getElementsByClassName("rankImage").item(0).alt){
		...
		case "5 Star":
			...
			break;
		case "4 Star":
			document.getElementsByClassName("rankImage").item(0).src = "https://lh3.googleusercontent.com/Bwf8MNAs7sW7dS0yM42K8h01HpBWEkGZ2YCv7uuRF9UcwTwhhDHng_is68KxmlyjWxu0TCImhqhz5c5mxchavEUMEmd6mn3HE8b9QXjho4q-PTrYh89DdK5SmRT9brb2r56YGBnykw=w1920-h1080";
			break;
		case "3 Star":
			...
			break;
		case "2 Star":
			document.getElementsByClassName("rankImage").item(0).src = "https://lh3.googleusercontent.com/NvkueZjBKYki85ameXlwsXY_mS83G6hJExSULArjG29rr53WgjYgB-Se8_By4FrEuq5Hv3wa8Vu4x3T_sM04tEW5Oy_FtFLaqNuydJhzbej9blrZn_VDvbtxnEFj9lxlcYtjqBPBXg=w1920-h1080";
			break;
		case "1 Star":
			document.getElementsByClassName("rankImage").item(0).src = "https://lh3.googleusercontent.com/kOFwXYezHdix8CBVy_QOni9fXbfAEbZuIk_l9ZMXd_8n1jxhg3MIKBQLDWQ0DDQGF25JYpszku_tM8yM1UYfaSCkze3ZBZdoiwsqRf4uCExmItCVBqY-N59yeA8L1Q6-VF_fdh8oFA=w1920-h1080";
			break;
	}
}
...
function toolNature(){
	for(let i = 0; i < 6; i ++){
		switch(document.getElementsByClassName("statTypeImage").item(i).alt){
			...
			case "Annihilation":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/NOLLDdLGy7hB1hMCMLNnJFlyvZLE0_XBwdC5zM6hURn5hmfwx_lUBQwhlmTDlUpLUPE8pnZjQl5-2zkPjHPf2yN8e071EregFby353BKSvilc3sHF7k-Bc3b2uxwHl1kOlqniy7V8g=w1920-h1080";
				break;
			case "Impact":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/uhbu5jvMWRkiCRMk4AYnVY0egUtA0HA1Dbr8_vx2jdDleHzOl6M-IYE25Wbkv0eFXSbNNuXxwQzA3Wei44-fOH6lQQumHqs7F2hEa7xGNp1z5v95C4wjD7TnrmtDTD0_qGGvDKEFYw=w1920-h1080";
				break;
			case "Lunge":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/ZMVVAnAufW9GxDPY0mG-uOHwUpnaMmVuyL6KeDj9CTOsCMuce3OsKMA2HqCMZQ1-b_G0BKdeI0u6Lo7iK6hEt9H_wFiLKokqESN_DVrSjzU6RUNdx-JqLJrz5Ft2Qll3cUlaFSWFag=w1920-h1080";
				break;
			case "Manipulate":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/mONwFde0kbFRJ65z4Xh6jxY1bIWKr-ofo45026e_Fo2CljebhRz8iZhSa1wxCziewqMTYUCIdDKYnCeNrp4pAFZ0NxGKJamL9VaWfgkEQwb_1PAQIX466T3XIlmA3F3jXDhyfo8HRA=w1920-h1080";
				break;
			case "Normal":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/633QSqfYrQxqlNKIr1oi8UOpkt7K2DgcEVfxumdU4My4a9I2hIZzd_8DIfT6ZEpBbXntkFi9MBOT682yhrwJVwKH6zn94tiMQ6VZmfi6zqGbCGnr-GcRrZAQ_-PwMlDI5sztuMKL2g=w1920-h1080";
				break;
			case "Release":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/sBGOzXlLcjUJvuSdmW7d75nrI7Qu7xlWSgiJxltfbDmJWZu1aqIncUg4RlBBs5szbb8u0GI5UMpgMwBVu9Ply5uAeDlao0A-ZuMgCboZ-Gd7auMZdbnvlvcVaRAMteUrsasVo0m5SQ=w1920-h1080";
				break;
			
			case "EX Annihilation":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/MmGvgNyHAowQabb6cpW2cwhNuww2QmUS18a0Yp2GJJ7O4-kNJ9W8WUQNybLmojRrnnlXM5BVKk6NmYfQIoinvkAVJVLBlc82eFNCh693OM0fFznOFMNdaZC3IHkHUDRzpob4eTePUw=w1920-h1080";
				break;
			case "EX Impact":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/h7iZufidRjqZqLxHhPlhSr1xfLtxo7dVgGUGnwiuNzEnqDgYj3JarxkMYG4SGgnp5IpVc5pkQFpcb0cXU9r5GQnkMS0UvDkqq3vtiUoVpD8ImfQhwJICCaHK27eQpcZy2sZQlyW9WA=w1920-h1080";
				break;
			case "EX Lunge":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/K-qzte8UTuyYiCvWjh2n-0bXqGTosiyDKYoIRNgC-zsjt3yYQ9j4yDET_DBDV8UX1W1P4eswN1jb_kFqszuqrMmPD8-h9npZqpOQTXeNM_xKp2wEFSl6Mc-3XwtRWFPedK99zLWaOA=w1920-h1080";
				break;
			case "EX Manipulate":
				document.getElementsByClassName("statTypeImage").item(i).src = "https://lh3.googleusercontent.com/lM0HmS2mTKV6mOx1JJanJsuYdPjEBTM2ziSN7qFjIp3F0TMg1QW23qlYfTjO8vYiDVxyMBCXv_QNvZE_l49mIOaAlh9vM-WGbx6j-U2R40Cb29iVCw7GiYS_GgMr7lUMnI2Y04iC2Q=w1920-h1080";
				break;
			case "EX Release":

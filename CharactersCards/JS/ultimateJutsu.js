function ultimateJutsu(){
	let rows = [[]] , rowsUJCheckByLvl = [[]] , rowsUltimateJutsu = [[]] , rowsLength;
	...
	for(let i = 0 , j = 0; i < (rowsLength - 1) / 2, j < (rowsLength - 1) / 2; i = i + 2, j ++){
		rowsUJCheckByLvl[j] = document.getElementById("ultimateJutsuCheckByLv").rows[2 + i].cells;
	}
	
	for(let i = 2 , j = 1; i < (rowsLength - 1) / 2, j < ((rowsLength - 1) / 2) - 1; i ++, j ++){
		rowsUJCheckByLvl[i][1].innerHTML = eval("parseInt(rowsUJCheckByLvl[1][1].innerHTML) + ( parseInt(rowsUJCheckByLvl[1][1].innerHTML) - parseInt(rowsUJCheckByLvl[0][1].innerHTML) ) * j");
		rowsUJCheckByLvl[i][3].innerHTML = eval("parseInt(rowsUJCheckByLvl[1][3].innerHTML) + ( parseInt(rowsUJCheckByLvl[1][3].innerHTML) - parseInt(rowsUJCheckByLvl[0][3].innerHTML) ) * j");
		rowsUJCheckByLvl[i][5].innerHTML = eval("parseInt(rowsUJCheckByLvl[1][5].innerHTML) + ( parseInt(rowsUJCheckByLvl[1][5].innerHTML) - parseInt(rowsUJCheckByLvl[0][5].innerHTML) ) * j") + ".00%";
		rowsUJCheckByLvl[i][7].innerHTML = eval("parseInt(rowsUJCheckByLvl[1][7].innerHTML) + ( parseInt(rowsUJCheckByLvl[1][7].innerHTML) - parseInt(rowsUJCheckByLvl[0][7].innerHTML) ) * j");
	}
	...
	switch(document.getElementsByClassName("cardLevel").item(0).innerHTML){
		case "Lv 70/70":
			...
			rowsUltimateJutsu[0][2].innerHTML = rowsUJCheckByLvl[7][3].innerHTML;
			rowsUltimateJutsu[0][4].innerHTML = rowsUJCheckByLvl[7][5].innerHTML;
			rowsUltimateJutsu[0][6].innerHTML = rowsUJCheckByLvl[7][7].innerHTML;
			rowsUltimateJutsu[1][1].innerHTML = rowsUJCheckByLvl[7][1].innerHTML;
			break;
		case "Lv 100/100":
			...
			rowsUltimateJutsu[0][2].innerHTML = rowsUJCheckByLvl[14][3].innerHTML;
			rowsUltimateJutsu[0][4].innerHTML = rowsUJCheckByLvl[14][5].innerHTML;
			rowsUltimateJutsu[0][6].innerHTML = rowsUJCheckByLvl[14][7].innerHTML;
			rowsUltimateJutsu[1][1].innerHTML = rowsUJCheckByLvl[14][1].innerHTML;
			break;
	}
}
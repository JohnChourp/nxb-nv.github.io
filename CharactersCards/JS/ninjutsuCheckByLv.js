function ninjutsuCheckByLv() {
	let row4,row6,row8,row10,row12,row14,row16,RT1,RT2,CPCost1,CPCost2,CRI1,CRI2,POW1,POW2,rowMax6,rowMax7;
	...
	if(document.getElementsByClassName ( "cardLevel" ).item(0).innerHTML === "Lv 60/60") {
		RT1 = document.getElementsByClassName ( "RT1" ).item ( 0 ).innerHTML;
		RT2 = document.getElementsByClassName ( "RT2" ).item ( 0 ).innerHTML;
	...
	if(document.getElementsByClassName ( "cardLevel" ).item(0).innerHTML === "Lv 40/40") {
		RT1 = document.getElementsByClassName ( "RT1" ).item ( 0 ).innerHTML;
		RT2 = document.getElementsByClassName ( "RT2" ).item ( 0 ).innerHTML;
		...
		row4[ 1 ].innerHTML = eval ( "parseInt(RT2)" );
		row4[ 3 ].innerHTML = eval ( "parseInt(CPCost2) + ( parseInt(CPCost2) - parseInt(CPCost1) )" );
		row4[ 5 ].innerHTML = eval ( "parseInt(CRI2) + ( parseInt(CRI2) - parseInt(CRI1) )" ) + ".00%";
		row4[ 7 ].innerHTML = eval ( "parseInt(POW2) + ( parseInt(POW2) - parseInt(POW1) )" );

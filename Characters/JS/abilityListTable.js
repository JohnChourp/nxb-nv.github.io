function createAbilityListTable(){
	...
	for(let i = 3; i < 72; i ++){
		if(i !== 22 && !(i > 26 && i < 30) && !(i > 33 && i < 39) && i < 42){
			...
			let equipBy = document.createElement("a");
			equipBy.classList.add("equipBy");
			equipBy.href = "../../CardsTools/NarutoUzumaki/UltimateJutsus/the-final-gamble.html";
			equipBy.innerHTML = "The Final Gamble!!";
			rows[i][3].appendChild(equipBy);
			...
			let equipBy = document.createElement("a");
			equipBy.classList.add("equipBy");
			equipBy.href = "../../CardsTools/NarutoUzumaki/UltimateJutsus/a-rampaging-power.html";
			equipBy.innerHTML = "A Rampaging Power!";
			rows[i][3].appendChild(equipBy);

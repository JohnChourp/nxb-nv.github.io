function natureImages(){
	...
	for(let i = 0; i < jutsuNatureImageItemLength.length; i ++){
		switch(document.getElementsByClassName("jutsuNatureImage").item(i).alt){
			case "Annihilation":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLWmJSKRrMBoxVe97tPSjDxF_2hgc5npP1oOLB95bmFx5BGDcjnhlOShQ_3FnLuBKyigxS5_pUenwE0yveCicHgzWQQosGqJf6P6NeElVxavXLcrGmO38IDg2L37qotyBahQyOz0zftMb8vHWd-v5lxI=w71-h72-no?authuser=0";
				break;
			case "Impact":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLWznlPlnQu0HJbnzZqMjCUT4tgj_9iw1oR2UohXOrnNP16bovpThcDTpdhp8kgQJSFXElh-h6EzjojKyq-5JeoudW4wUFf4H8VlGMBjcr_gIm7ui2THowBj_UD75x7mt2V6teuyOB2wgYUkRxd-hok-=w71-h72-no?authuser=0";
				break;
			case "Lunge":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLXZYvevr4WjVu8ahLZKn5R0CprN6n-TvRarKP9OMjNf1IVOsBsMPwuRUnk-r-PgczaZ2iBmSpFW0g8KpWeZOCzqm9J9LoeqMeLseZD0YGOZ4mLwacN5EXJx7k5q9vGrLz5425UdZeKltkXSSyeclVXz=w71-h70-no?authuser=0";
				break;
			case "Manipulate":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLUQxENiClqAty10E7swJeuevEHHvu6lziyc93woPeO7M-TDmk9MqVZYeZrr9uH60xDpNhl13_gtf-9KBnGJb7EcpmDdd9X4d1-uAo-u2kh4UculU0uLLj4J-FJf64tT5plBNXzG5bD8k1fCItI90I9U=w71-h72-no?authuser=0";
				break;
			case "Normal":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLUha6py0kmhL3kUpocySGa5gHZGbzDLyaSoIWuiInOA8Kngfvr7YIIPuUqGL3FJ9GV7aT_6gV7Cg8V84kDx4cCDsPtC4D649qWI-k-x-S_0PmtroVJ5aQGYYT-kfoEO_wPTjv09E15Zbi97iVu-hm3Y=w71-h72-no?authuser=0";
				break;
			case "Release":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLUWBFLU0g5gFe_i0_RVUIZwq43V9G0wpdCZUTgZIrEi1afmA6z2MpVhbK_STWV9kYMubmoruL9CRiW8-kIVewDvpfpNiTeyzmqSQCItprL3xCLipzHhlLijW3O0Y7wXPtdWQ-r4eqwscqdMZ7JgTl0w=s71-no?authuser=0";
				break;
			case "EX Annihilation":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLWEtKf1IOnmHwQi4zpLBiGlW--nLAOF55nEGv-Ik2NysVi5LFtRn8-6O-SiDa3jUjC4aGXG5OxeNahqABd9zX6n9IChTTd7-1-TRUDiKTT4Ow51YdVA8uppn5QBp_KPJvjv6FEghSHJTKb6cohQ-Vv9=s88-no?authuser=0";
				break;
			case "EX Impact":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLVfV_ajGTgdqdUGlyFiwSZR4Cms0E_itwx3jti5lRfbhIBfd-vK69G9a4144t-QdXFbM5qRq8ztuF1VJudVCbX0q66a5mV4m74PrXgKxWfthX0pojELNMbd14OElWPRbt8zv8p7A5GgFnjsztNMMOcN=s85-no?authuser=0";
				break;
			case "EX Lunge":
				document.getElementsByClassName("jutsuNatureImage").item(i).src = "https://lh3.googleusercontent.com/pw/AM-JKLWHe_MPcY1oA-sSudXG3wjgAxhyblDGtUVjW96qOCY4XINiLGZvGQpMN-ZfgC13V7w4t9gqcTQzZsnUtzOctjXdKacoKjjMCRtzIoJXQ6ibfKY07fn3AquVqkP9eOXPph45_Uokcw30_NgQPCJmqoRg=w88-h85-no?authuser=0";
				break;
			case "EX Manipulate":
				document.getElementsByClassName("jutsuNatureImage").src = "https://lh3.googleusercontent.com/pw/AM-JKLVmGx7QjWr0WAY6pml5TnxcDP7_uiNeuavPgl9s9TpI2vHR3c9FTN-iATV9aQLiiphXw3-tapJlw2xQ4ia_hr3iRq_qfRvacsvh29K5AFvQRQ5Sw2F3kofh9wYR0nF0vNUKUWLZBwmHeOxR4EX9vpSS=w93-h86-no?authuser=0";
				break;
			case "EX Release":
				document.getElementsByClassName("jutsuNatureImage").src = "https://lh3.googleusercontent.com/pw/AM-JKLVcrPw39IQDtWnpkJyrkmelWfXw51SyEyJkDzl1CgSSG3Ek5Hu4qwG2fYTUG1-bv_PgfK6P4Drqlt8F9qRmaTm3MDxyGy_nMXJuiMpsiklTI5eNeLO4aFTr8uSi79gJ_Zp4ar1SFZYmYS8ufKAkar0T=w94-h87-no?authuser=0";
				break;
		}
	}
}
